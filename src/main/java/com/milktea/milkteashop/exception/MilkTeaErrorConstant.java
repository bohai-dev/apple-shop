...
public enum MilkTeaErrorConstant {
    ...
    CN_CLASS_NAME_REQUIRED("00003", "分类名称不能为空", "Class name required"),
    
    US_CLASS_NAME_REQUIRED("00004", "分类名称（英文）不能为空", "Class name required"),
    
    CN_CLASS_LOGO_REQUIRED("00005", "分类logo不能为空", "Class logo required"),
    ...
    CN_ATTR_NAME_REQUIRED("00009", "商品属性名称不能为空", "Attribute name required"),
    ...
    CN_GOODS_NAME_REQUIRED("00013", "商品名称不能为空", "Goods name required"),
    ...
    CN_PROMOTION_NAME_REQUIRED("00019", "活动名称不能为空", "Promotion name required"),
    ...
    CN_FIGURE_ADDRESS_REQUIRED("00022", "轮播图地址不能为空", "Figure address required"),
    ...
    CN_STORE_NAME_REQUIRED("00028", "店铺名称不能为空", "Store name required"),
    ...
    CN_GOODS_NAME_EXISTS("00033", "商品名称重复", "Goods name already exists"),
    ...
    CN_STORE_NAME_EXISTS("00040", "店铺名称重复", "Store name already exists"),
    
    US_STORE_NAME_EXISTS("00041", "店铺名称(英文)重复", "Store name already exists"),
    
    CN_ATTR_NAME_EXISTS("00042", "属性名称重复", "Attr name already exists"),
    ...
    CN_CLASS_NAME_EXISTS("00057", "分类名称已存在", "Class name already exists"),
